...
Algorithm:
- Turn the entire string into an array of sentences 
- Use each with index to iterate through the array of sentences, store the length and index if it's greater than the previous
- Return a sentence printing the longest sentence and the word count
...
def longest_sentence(string)
  ...
  "Here is the longest sentence: #{sentences[-1]}. It is #{sentences[-1].split(" ").length} words long."
end
