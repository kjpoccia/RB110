...
# loop do #this loop is just for correctly capitalizing each name
#   break if counter == mailing_campaign_leads.size
#   full_name = mailing_campaign_leads[counter][:name]
#   names = full_name.split
#   # assign name to full_name variable, then put the full name into an array

#   names_counter = 0
#   loop do # this loop capitalizes each name in the array
...
# loop do #this loop adds each hash to an array if they have logged in < 60 days ago and are subscribed
#   break if counter == mailing_campaign_leads.size
